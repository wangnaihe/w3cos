...
<Column style={{ gap: 20, padding: 48, alignItems: "center", justifyContent: "center", background: "#0f0f1a" }}>
  ...
  <Text style={{ fontSize: 20, color: "#a0a0b0" }}>TypeScript compiled to native binary.</Text>
  ...
  <Text style={{ fontSize: 14, color: "#404050" }}>2.4 MB native binary  |  &lt; 100ms startup  |  10 MB RAM</Text>
</Column>
