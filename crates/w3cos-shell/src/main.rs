...
fn build_terminal_app() -> Component {
    Component::column(
        Style {
            flex_grow: 1.0,
            background: Color::from_hex("#0c0c14"),
            gap: 0.0,
            ..Style::default()
        },
        vec![
            ...
            Component::column(
                ...
                vec![
                    ...
                    Component::text(
                        "   Compiling w3cos-runtime v0.1.0",
                        Style {
                            font_size: 13.0,
                            color: Color::from_hex("#a0a0c0"),
                            ..Style::default()
                    ...
                    Component::text(
                        "    Finished release [optimized] in 42.3s",
                        Style {
                            font_size: 13.0,
                            color: Color::from_hex("#00b894"),
                            ..Style::default()
                    ...
                    Component::text(
                        "W3C OS Desktop Shell v0.1.0 -- starting...",
                        Style {
                            font_size: 13.0,
                            color: Color::from_hex("#a0a0c0"),
                            ..Style::default()
                ...
                vec![
                    ...
                    Component::column(
                        ...
                        vec![
                            ...
                            chat_msg(
                                "System",
                                "Agent connected. DOM access granted (Layer 1 + 2). Permission: interactive.",
                                "#141428",
                                "#606080",
                            ),
                            chat_msg(
                                "Code Agent",
                                "I can see 47 DOM elements, 12 interactive buttons, 3 text inputs. All elements properly labeled in the a11y tree.",
                                "#1c1c34",
                                "#6c5ce7",
                            ),
                            chat_msg(
                                "You",
                                "Build a file manager with tree view sidebar.",
                                "#6c5ce7",
                                "#ffffff",
                            ),
                            chat_msg(
                                "Code Agent",
                                "Creating component tree via DOM API... 24 operations completed in 0.3ms.",
                                "#1c1c34",
                                "#6c5ce7",
                            ),
                            Component::row(
    ...
    Component::column(
        ...
        vec![
            Component::text(
                ...
                Style {
                    font_size: 11.0,
                    color: Color::from_hex(sender_color),
                    font_weight: 600,
                    ..Style::default()
                },
            ),
...
fn build_browser_app() -> Component {
    Component::column(
        Style {
            flex_grow: 1.0,
            background: Color::from_hex("#0e0e18"),
            gap: 0.0,
            ..Style::default()
        },
        vec![
            ...
            Component::row(
                Style {
                    ...
                    background: Color::from_hex("#14142a"),
                ...
                vec![
                    ...
                    Component::column(
                        Style {
                            ...
                            border_radius: 12.0,
                            gap: 16.0,
                            max_width: Dimension::Px(600.0),
                            ..Style::default()
                        },
                        vec![
                            Component::text(
                                "Welcome to the W3C OS Browser",
                                Style {
                                    font_size: 16.0,
                                    color: Color::from_hex("#f0f0ff"),
                                    font_weight: 600,
                            ...
                            Component::text(
                                "Applications are rendered natively using the W3C DOM model — no Chromium, no V8. TypeScript is compiled to native Rust binaries.",
                                Style {
                                    font_size: 13.0,
                                    color: Color::from_hex("#808090"),
                                    ..Style::default()
    ...
    Component::column(
        ...
        vec![
            ...
            Component::row(
                Style {
                    height: Dimension::Px(36.0),
                    background: Color::from_hex("#181828"),
                    padding: Edges::xy(8.0, 4.0),
                    gap: 16.0,
                    align_items: AlignItems::Center,
                    ..Style::default()
                ...
                vec![
                    Component::button(
                        ...
                        Style {
                            font_size: 12.0,
                            color: Color::from_hex("#808090"),
                            background: Color::from_hex("#2a2a3e"),
                            border_radius: 4.0,
                            ..Style::default()
                        },
                    ),
